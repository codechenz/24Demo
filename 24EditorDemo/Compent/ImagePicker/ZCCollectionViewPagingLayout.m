//
//  ZCCollectionViewPagingLayout.m
//  24EditorDemo
//
...
@interface ZCCollectionViewPagingLayout () {
...
@implementation ZCCollectionViewPagingLayout (ScaleStyle)
...
const CGFloat ZCCollectionViewPagingLayoutRotationRadiusAutomatic = -1.0;

@implementation ZCCollectionViewPagingLayout (RotationStyle)
...
@implementation ZCCollectionViewPagingLayout

- (instancetype)initWithStyle:(ZCCollectionViewPagingLayoutStyle)style {
    if (self = [super init]) {
        _style = style;
        ...
        self.rotationRadius = ZCCollectionViewPagingLayoutRotationRadiusAutomatic;
...
- (instancetype)init {
    return [self initWithStyle:ZCCollectionViewPagingLayoutStyleDefault];
}
...
- (BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)newBounds {
    if (self.style == ZCCollectionViewPagingLayoutStyleScale || self.style == ZCCollectionViewPagingLayoutStyleRotation) {
        return YES;
    }
...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect {
    if (self.style == ZCCollectionViewPagingLayoutStyleDefault) {
    ...
    if (self.style == ZCCollectionViewPagingLayoutStyleScale) {
    ...
    if (self.style == ZCCollectionViewPagingLayoutStyleRotation) {
        if (self.rotationRadius == ZCCollectionViewPagingLayoutRotationRadiusAutomatic) {
